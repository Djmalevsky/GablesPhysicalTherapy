                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="cart-product-thumbnail">
                                        <a href="#">
                                            <img src="images/shop/products/6.jpg" alt="Mountain Hoodie">
                                        </a>
                                        <div class="cart-product-thumbnail-name">Mountain Hoodie</div>
                                    </td>
                                    <td class="cart-product-description">
                                        <p>Warm hoodie made from premium materials, featuring a mountain graphic on the back. Comfortable fit.</p>
                                    </td>
                                    <td class="cart-product-price">
                                ...
                                <tr>
                                    ...
                                    <td class="cart-product-thumbnail">
                                        <a href="#">
                                            <img src="images/shop/products/7.jpg" alt="Stripe Tee">
                                        </a>
                                        <div class="cart-product-thumbnail-name">Stripe Tee</div>
                                    </td>
                                    <td class="cart-product-description">
                                        <p>Short sleeve t-shirt with horizontal stripes. Made from soft cotton. Regular fit.</p>
                                    </td>
                                    <td class="cart-product-price">
                                ...
                                <tr>
                                    ...
                                    <td class="cart-product-thumbnail">
                                        <a href="#">
                                            <img src="images/shop/products/8.jpg" alt="Denim Jacket">
                                        </a>
                                        <div class="cart-product-thumbnail-name">Denim Jacket</div>
                                    </td>
                                    <td class="cart-product-description">
                                        <p>Classic denim jacket with button closure and chest pockets. Perfect for every season.</p>
                                    </td>
                                    <td class="cart-product-price">
